...
public class WaresAddAndSubView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public WaresAddAndSubView(Context context) {
        this(context,null);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WaresAddAndSubView(Context context, @Nullable AttributeSet attrs) {
        this(context,attrs,0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WaresAddAndSubView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context,attrs,defStyleAttr,0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WaresAddAndSubView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
